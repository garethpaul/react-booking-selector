...
`LICENSE`.
`corepack yarn docs:smoke` builds the docs, serves them locally, captures desktop and mobile screenshots with
headless Chrome or Chromium, and checks the rendered DOM and screenshots.
